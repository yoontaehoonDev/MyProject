...
public class BuyerCommentTable implements DataTable {

  File jsonFile = new File("buyerComments.json");
  List<Comment> list;

  public BuyerCommentTable() {
