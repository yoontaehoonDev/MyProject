...
public class Project {
	...
	public static void main(String[] args) {
		...
		String[] biochemistryBomb = new String[MAX];
		String[] stealthFuction = new String[MAX];
		int devCount = 0;

		String[] nations = {"미국", "러시아", "이란", "인도", "호주", "캐나다", "뉴질랜드", "파키스탄", "몽골", "필리핀",
				"대만", "태국", "베트남", "인도네시아", "중국", "일본", "북한"
		};
		int[] population = { 332000000, 145000000, 85000000, 1393000000, 25000000, 38000000,
				4860000, 225000000, 3320000, 111000000, 230000000, 70000000, 98000000,
				276000000, 1444000000, 126000000, 25000000
		};
		int[] deadPeople = new int[17];
		...
		int nuclearDamage = 5384923;
		int biochemistryDamage = 2837194;
		int bombDamage = 134728;
