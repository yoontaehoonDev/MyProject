...
public class MemberHandler {
	...
	public BuyerBoardHandler buyerBoardList;
	...
	public void service() throws CloneNotSupportedException {
		...
		while(true) {
			...
			case "설정":
				...
				break;
			case "구매자게시판":
				buyerBoardListMenu.service();
				break;
			case "판매자게시판":
				sellerBoardListMenu.service();
				break;
			case "통합게시판":
				integratedBoardListMenu.service();
				break;
			case "뒤로가기":
	...
	public void setting() throws CloneNotSupportedException {
		String name, choice;
