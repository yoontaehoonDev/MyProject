...
public class SellerBoardDetailHandler extends AbstractSellerBoardHandler {
  ...
  public SellerBoardDetailHandler(List<Board> sellerBoardList, List<Comment> sellerCommentList) {
  ...
  public void service() {
    ...
    String choice;
    SellerBoardListHandler list = new SellerBoardListHandler(sellerBoardList, sellerCommentList);
    list.service();

    System.out.println("---------------------------------------");
    System.out.println("■ 메뉴 - 판매자 게시판 - 게시글 보기 ■");
