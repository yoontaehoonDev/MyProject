...
public class OrderAddHandler extends AbstractOrderHandler {
  ...
  public OrderAddHandler(List<Order> orderList, List<BuyerMember> buyerMemberList, List<SellerMember> sellerMemberList) {
    super(orderList);
  ...
  public void service() {
    ...
    while(true) {
      ...
      OrderRestaurantListHandler list = new OrderRestaurantListHandler(buyerMemberList, sellerMemberList);
      list.service();
