...
select bs_name, bs_hour
from seller where category = ? 

select s.category, s.bs_name, s.bs_hour
from category c
inner join seller s on s.category=c.no
where c.no = ?




insert into memb(id,pwd,name,nick_name,tel,email,addr)
values('asdf','1111','1','1','1','1','1');
insert into seller(m_no, bs_name,bs_no,bs_hour,category)
values(?, '11','11','11','11');
